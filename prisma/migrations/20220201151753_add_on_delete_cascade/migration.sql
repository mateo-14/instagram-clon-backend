...
-- DropForeignKey
ALTER TABLE "Comment" DROP CONSTRAINT "Comment_commentRepliedId_fkey";
...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_commentRepliedId_fkey" FOREIGN KEY ("commentRepliedId") REFERENCES "Comment"("id") ON DELETE CASCADE ON UPDATE CASCADE;
